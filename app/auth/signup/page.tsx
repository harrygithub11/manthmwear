      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 py-12">
        <div className="bg-white border-2 border-text-black p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-sm font-bold tracking-wider-xl uppercase mb-2">
                Name
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="mt-1 text-xs text-gray-secondary">At least 8 characters</p>
            </div>

            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-bold tracking-wider-xl uppercase mb-2">
                Confirm Password
              </label>
              <input
                type="password"
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link href="/auth/signin" className="font-bold underline hover:text-gray-secondary">
              Sign In
            </Link>
          </div>
        </div>
